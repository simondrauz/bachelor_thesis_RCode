...
data {
    ...
    real a_tau_X1_squared;                                // Shape parameter for InverseGamma of tau for X1
    real b_tau_X1_squared;                                // Scale parameter for InverseGamma of tau for X1
    real a_tau_X2_squared;                                // Shape parameter for InverseGamma of tau for X2
    real b_tau_X2_squared;                                // Scale parameter for InverseGamma of tau for X2
...
parameters {
    ...
    real<lower=0> tau_X1_squared;                                          // Precision parameter for Gaussian random walk for X1
    real<lower=0> tau_X2_squared;                                          // Precision parameter for Gaussian random walk for X2
...
transformed parameters {
    ...
    covariance_matrix_X1_penalized = tau_X1_squared * diag_matrix(rep_vector(1, no_basis_X1-random_walk_order_X1));       
                                                                    // Defining covariance matrix of penalized spline 
                                                                    // coefficients for X1 
    covariance_matrix_X2_penalized = tau_X2_squared * diag_matrix(rep_vector(1, no_basis_X2-random_walk_order_X2));       
                                                                    // Defining covariance matrix of penalized spline 
                                                                    // coefficients for X2 
}
...
model {
  // Priors
    ...
    tau_X1_squared ~ inv_gamma(a_tau_X1_squared, b_tau_X1_squared);                           // Inverse Gamma prior for tau_X1_squared
    tau_X2_squared ~ inv_gamma(a_tau_X2_squared, b_tau_X2_squared);                          // Inverse Gamma prior for tau_X2_squared
