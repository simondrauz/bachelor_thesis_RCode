...
generated quantities {
  // Declare the matrices you want to retrieve
  matrix[no_data, no_basis_X1] generated_basis_X1;
  matrix[no_data, no_basis_X2] generated_basis_X2;
  matrix[no_data_eval, no_basis_X1] generated_basis_X1_eval;
  matrix[no_data_eval, no_basis_X2] generated_basis_X2_eval;
  matrix[no_basis_X1-random_walk_order_X1, no_basis_X1] generated_difference_matrix_first_order_X1;
  matrix[no_basis_X2-random_walk_order_X2, no_basis_X2] generated_difference_matrix_first_order_X2;
  matrix[no_basis_X1, no_basis_X1-random_walk_order_X1] generated_random_effects_matrix_X1;
  matrix[no_basis_X2, no_basis_X2-random_walk_order_X2] generated_random_effects_matrix_X2;
  matrix[no_basis_X1, random_walk_order_X1] generated_polynomial_space_matrix_X1;
  matrix[no_basis_X2, random_walk_order_X2] generated_polynomial_space_matrix_X2;

  // Copy the matrices from the transformed data block
  generated_basis_X1 = basis_X1;
  generated_basis_X2 = basis_X2;
  generated_basis_X1_eval = basis_X1_eval;
  generated_basis_X2_eval = basis_X2_eval;
  generated_difference_matrix_first_order_X1 = difference_matrix_first_order_X1;
  generated_difference_matrix_first_order_X2 = difference_matrix_first_order_X2;
  generated_random_effects_matrix_X1 = random_effects_matrix_X1;
  generated_random_effects_matrix_X2 = random_effects_matrix_X2;
  generated_polynomial_space_matrix_X1 = polynomial_space_matrix_X1;
  generated_polynomial_space_matrix_X2 = polynomial_space_matrix_X2;
}
