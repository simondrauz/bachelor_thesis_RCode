...
data {
    ...
    real a_tau_squared_linear;
    real b_tau_squared_linear;
...
parameters {
    ...
    real<lower=0> tau_squared_linear;
}
...
transformed parameters {
    ...
    matrix[no_lin_covariates, no_lin_covariates] covariance_matrix_linear_effects;
    ...
    covariance_matrix_linear_effects = tau_squared_linear * diag_matrix(rep_vector(1, no_lin_covariates));   
}
...
model {
  // Priors
    ...
    tau_squared_linear ~ inv_gamma(a_tau_squared_linear, b_tau_squared_linear);
    ...
    linear_coefficients ~ multi_normal(rep_vector(0, no_lin_covariates), covariance_matrix_linear_effects);
