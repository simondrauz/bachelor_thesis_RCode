...
sm = stan_model(file = "C:/Users/Uwe Drauz/RProjects/bachelor_thesis/RModels/bayesian_psplines_gaussian_prior_integrated_functionalities_reparameterized_verify_matrices.stan")

fit <- sampling(sm, data = stan_data, iter = 1, chains = 1, algorithm = "Fixed_param", seed = 123)

# Extract the generated quantities from the fit object
extracted_data <- extract(fit, permuted=TRUE)

# Retrieve the matrices
generated_basis_X1 = extracted_data$generated_basis_X1[1,,]
generated_basis_X2 = extracted_data$generated_basis_X2[1,,]
generated_basis_X1_eval = extracted_data$generated_basis_X1_eval[1,,]
generated_basis_X2_eval = extracted_data$generated_basis_X2_eval[1,,]
generated_difference_matrix_first_order_X1 = extracted_data$generated_difference_matrix_first_order_X1[1,,]
generated_difference_matrix_first_order_X2 = extracted_data$generated_difference_matrix_first_order_X2[1,,]
generated_random_effects_matrix_X1 = extracted_data$generated_random_effects_matrix_X1[1,,]
generated_random_effects_matrix_X2 = extracted_data$generated_random_effects_matrix_X2[1,,]
generated_polynomial_space_matrix_X1 = extracted_data$generated_polynomial_space_matrix_X1[1,,]
generated_polynomial_space_matrix_X2 = extracted_data$generated_polynomial_space_matrix_X2[1,,]
