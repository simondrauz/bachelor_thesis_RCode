...
sm = stan_model(file = "C:/Users/Uwe Drauz/RProjects/bachelor_thesis/RModels/bayesian_psplines_gaussian_prior_integrated_functionalities_reparameterized_zinb.stan")
