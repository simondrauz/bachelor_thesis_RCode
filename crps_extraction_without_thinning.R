...
model_name = 'model23_zinb_feature_set4'
crps_dfs <- list()
pps_list <- list()
...
create_pps_dataframe <- function(model_fit, eval_id) {
  ...
  # draw_indexes <- seq(1, nrow(y_eval_samples), by = 1)
  # n_samples <- nrow(y_eval_samples)
  # n_select <- 1000
  
  #if (n_samples > n_select) {
  #  draw_indexes <- sample(1:n_samples, size = n_select)
  #} else {
  #  draw_indexes <- 1:n_samples
  #}
  
  draw_indexes <- 1:nrow(y_eval_samples)
...
arrow::write_parquet(crps_averages_df, paste0("C:/Users/Uwe Drauz/Documents/bachelor_thesis_local/personal_competition_data/Results/", model_name, "_crps_df_averages_wt.parquet"))
arrow::write_parquet(crps_averages_by_country_df, paste0("C:/Users/Uwe Drauz/Documents/bachelor_thesis_local/personal_competition_data/Results/", model_name, "_crps_averages_by_country_df_wt.parquet"))
arrow::write_parquet(concatenated_pps, paste0("C:/Users/Uwe Drauz/Documents/bachelor_thesis_local/personal_competition_data/Results/", model_name, "_posterior_predicitve_samples_wt.parquet"))
